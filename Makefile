...
DB_URL := clickhouse://$(CLICKHOUSE_HOST):$(CLICKHOUSE_NATIVE_PORT)/$(CLICKHOUSE_DB)?username=$(CLICKHOUSE_USER)&password=$(CLICKHOUSE_PASSWORD)&database=$(CLICKHOUSE_DB)&x-multi-statement=true
